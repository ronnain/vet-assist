...
export const ConversationCreateNestedManyWithoutUsersInputSchema: z.ZodType<Prisma.ConversationCreateNestedManyWithoutUsersInput> = z.object({
...
export default ConversationCreateNestedManyWithoutUsersInputSchema;
