...
export const PetCreateNestedManyWithoutOwnerInputSchema: z.ZodType<Prisma.PetCreateNestedManyWithoutOwnerInput> = z.object({
...
export default PetCreateNestedManyWithoutOwnerInputSchema;
