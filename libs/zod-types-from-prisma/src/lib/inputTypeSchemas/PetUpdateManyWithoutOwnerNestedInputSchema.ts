...
export const PetUpdateManyWithoutOwnerNestedInputSchema: z.ZodType<Prisma.PetUpdateManyWithoutOwnerNestedInput> = z.object({
...
export default PetUpdateManyWithoutOwnerNestedInputSchema;
