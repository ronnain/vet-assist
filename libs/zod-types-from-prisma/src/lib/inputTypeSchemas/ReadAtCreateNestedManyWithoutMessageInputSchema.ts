...
export const ReadAtCreateNestedManyWithoutMessageInputSchema: z.ZodType<Prisma.ReadAtCreateNestedManyWithoutMessageInput> = z.object({
...
export default ReadAtCreateNestedManyWithoutMessageInputSchema;
