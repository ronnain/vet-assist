...
export const ReadAtUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.ReadAtUncheckedCreateNestedManyWithoutUserInput> = z.object({
...
export default ReadAtUncheckedCreateNestedManyWithoutUserInputSchema;
