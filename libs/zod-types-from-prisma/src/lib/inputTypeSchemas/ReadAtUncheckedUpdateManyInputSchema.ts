...
export const ReadAtUncheckedUpdateManyInputSchema: z.ZodType<Prisma.ReadAtUncheckedUpdateManyInput> = z.object({
...
export default ReadAtUncheckedUpdateManyInputSchema;
