...
export const ReadAtUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ReadAtUncheckedUpdateManyWithoutUserNestedInput> = z.object({
...
export default ReadAtUncheckedUpdateManyWithoutUserNestedInputSchema;
