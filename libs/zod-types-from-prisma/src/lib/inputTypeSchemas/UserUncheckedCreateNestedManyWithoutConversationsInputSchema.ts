...
export const UserUncheckedCreateNestedManyWithoutConversationsInputSchema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutConversationsInput> = z.object({
...
export default UserUncheckedCreateNestedManyWithoutConversationsInputSchema;
